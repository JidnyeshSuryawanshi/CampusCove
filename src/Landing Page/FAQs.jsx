...
import { FaQuestionCircle, FaBook, FaUtensils, FaLock, FaCreditCard, FaRegCalendarAlt } from 'react-icons/fa'; // Import icons from react-icons
...
const FAQ = () => {
  ...
  return (
    <div className="bg-blue-50 min-h-screen flex justify-center items-center py-12">
      <div className="bg-white p-8 rounded-lg shadow-2xl w-[90%] md:w-[90%] flex flex-col md:flex-row">
        
        {/* Image Section */}
        <div className="w-full md:w-2/5 mb-6 md:mb-0 p-6">
          <img 
          ...
          <div className="space-y-4">
            ...
            <div className="border-b-2 shadow border-blue-300">
              <div
                ...
                className={`cursor-pointer p-4 rounded-md ${activeIndex === 0 ? 'bg-blue-100' : 'bg-gray-50'} transition-all flex items-center`}
              >
              ...
              {activeIndex === 0 && (
                <div className="bg-gray-50 p-4 shadow-2xl rounded-md mt-2">
                  <p className="text-gray-700">To book a hostel room, choose a location, and select the room number with availability of rooms.</p>
                </div>
              )}
            </div>
            ...
            <div className="border-b-2 border-blue-300">
              <div
                ...
                className={`cursor-pointer p-4 rounded-md ${activeIndex === 1 ? 'bg-blue-100' : 'bg-gray-50'} transition-all flex items-center`}
              >
            ...
            <div className="border-b-2 border-blue-300">
              <div
                ...
                className={`cursor-pointer p-4 rounded-md ${activeIndex === 2 ? 'bg-blue-100' : 'bg-gray-50'} transition-all flex items-center`}
              >
                <FaRegCalendarAlt className="text-xl mr-3" />
            ...
            <div className="border-b-2 border-blue-300">
              <div
                ...
                className={`cursor-pointer p-4 rounded-md ${activeIndex === 3 ? 'bg-blue-100' : 'bg-gray-50'} transition-all flex items-center`}
              >
              ...
              {activeIndex === 3 && (
                <div className="bg-gray-50 p-4 shadow-2xl rounded-md mt-2">
                  <p className="text-gray-700">Yes, we provide meal options in our hostel as well as separate food services at the mess. You can book your meals along with your hostel or book them separately.</p>
                </div>
              )}
            </div>
            ...
            <div className="border-b-2 border-blue-300">
              <div
                ...
                className={`cursor-pointer p-4 rounded-md ${activeIndex === 4 ? 'bg-blue-100' : 'bg-gray-50'} transition-all flex items-center`}
              >
            ...
            <div className="border-b-2 border-blue-300">
              <div
                ...
                className={`cursor-pointer p-4 rounded-md ${activeIndex === 5 ? 'bg-blue-100' : 'bg-gray-50'} transition-all flex items-center`}
              >
            ...
            <div className="border-b-2 border-blue-300">
              <div
                ...
                className={`cursor-pointer p-4 rounded-md ${activeIndex === 6 ? 'bg-blue-100' : 'bg-gray-50'} transition-all flex items-center`}
              >
                <FaQuestionCircle className="text-xl mr-3" />
